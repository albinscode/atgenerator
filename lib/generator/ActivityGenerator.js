...
function ActivityGenerator() {
    ...
    this.fillOneFile = function(promises, files, total, originalJsonObj, templateData, currentDay) {
        ...
        var filenamePattern = self.jsonObj.filenameFinalPattern ? self.jsonObj.filenameFinalPattern : self.jsonObj.filenamePattern;
        ...
        filenamePattern = replaceall('$$activityProject$$', self.jsonObj.activityProject, filenamePattern);
        ...
        if (self.jsonObj.filenameFinalPattern) {
