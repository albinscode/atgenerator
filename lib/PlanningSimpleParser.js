...
/**
 * A more simple planning parser that will retrieve all projects of the worker.
 * @param worker the name of the worker to extract work days as appearing in the planning.
 */
function PlanningSimpleParser(worker) {
    this.worker = worker;
}
 ...
 */
PlanningSimpleParser.prototype.parse = function(data) {
...
module.exports = PlanningSimpleParser;
