        ...
        .each(
            function (j, line) {
                ...
                if (line.root.html() === null) {
                    log.verbose('time parser', 'There is NO data for this month related to project code %j', self.projectCode);
                } else {
                    log.verbose('time parser', 'There are data for this month related to project code %j', self.projectCode);
                    var index = 0;
