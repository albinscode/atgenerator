    ...
    this.generateDeclarations = function(months, templateData) {
        try {
            ...
            processor.on(ActivityProcessorEmitter.EVENT_LAST_DAY_OF_WEEK, function(weekTotal, date) {
                ...
                var newTemplateFooter = filler.fill(self.jsonObj, templateData.footer);
                ...
                promises.push(provider.update(self.jsonObj.odtTemplate, self.jsonObj.filepath + '/' + filenamePattern, newTemplateContent, newTemplateFooter));
            });
            ...
            Promise.all(promises).then(function() {
                ...
                if (self.ifFollowUp) {
                    console.log(self.jsonObj.filepath);
                    var merger = require('./OdsMerger.js');
                    merger.merge(self.jsonObj.filepath, self.jsonObj.filenameFinalPattern);
                }
            });
        }
        catch (e) {
