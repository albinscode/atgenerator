...
/**
 * Perhaps a feature to develop a little bit more in the future.
 */
 ...
 */
CommandUtils.prototype.displayPrompt = function(program, enabledFeatures, json) {
    ...
    this.enabledFeatures = enabledFeatures.filter(function (element) {
        var result = json[element] === undefined || json[element] === '';
        return result;
    });
