                        ...
                        function (error, response, body) {
                            ...
                            request.post(
                                ...
                                function (error, response, body) {
                                    ...
                                    self.cookie = '';
                                    response.headers['set-cookie'].map(function (cookieString) {
                                        if (self.cookie) self.cookie = self.cookie + '; ';
                                        self.cookie = self.cookie + cookieString.split(';')[0] ;
                                    });

                                    log.verbose('connection with cookies', self.cookie);
