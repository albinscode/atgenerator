 ...
 */
PlanningGenerator.prototype.generate = function(jsonObj, user, password) {
    ...
    extractor.extract(user, password, this.date1, this.date2, false, parser).then(function(months) {
